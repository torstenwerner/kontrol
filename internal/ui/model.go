...
return m.styles.Body.Width(m.width).Height(bodyHeight).Render(body)
}
...
Body:        lipgloss.NewStyle().Border(lipgloss.RoundedBorder()).BorderForeground(lipgloss.Color("240")).Padding(0, 1),
